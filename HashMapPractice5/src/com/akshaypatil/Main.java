...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<String, InsuranceProducts> India = new HashMap<>();
        Map<String, InsuranceProducts> Japan = new HashMap<>();

        //To set Insurance products for the different states in the country India
        India.put("Maharashtra",insuranceProducts);
        India.put("Odisha",insuranceProducts);

        //To get product values
